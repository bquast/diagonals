...
# apply block_matrix()
bm8x8 <- minus_block_matrix(m8x8, 2)
bm9x9 <- minus_block_matrix(m9x9, 3)
...
test_that("output content matches", {
  expect_equal(rowSums(bm8x8), c(222, 228, 202, 208, 182, 188, 162, 168) )
  expect_equal(rowSums(bm9x9), c(303, 309, 315, 240, 246, 252, 177, 183, 189) )
})
